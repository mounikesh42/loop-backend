...
Usage:
    python load_to_db.py paths.json [--db ../../apicalls/pipeline.db]
"""
...
STAGES = [
    ("stage1_inventory",       "gcp_stage1_inventory",       "data"),
    ("stage2_source_fields",   "gcp_stage2_source_fields",   "data"),
    ("stage3_derived",         "gcp_stage3_derived",         "data"),
    ("stage3_indicators",      "gcp_stage3_indicators",      "data"),
    ("stage3_building_blocks", "gcp_stage3_building_blocks", "data"),
    ("stage3_gcp_score",       "gcp_stage3_gcp_score",       "data"),
]
